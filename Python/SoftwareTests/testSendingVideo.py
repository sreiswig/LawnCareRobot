...
def read_cam():
    ...
    gst_out = f"appsrc ! video/x-raw, format=BGR ! queue ! videoconvert ! nvv4l2h264enc ! h264parse ! rtph264pay pt=96 config-interval=1 ! udpsink host={config['mqtt']['host']} port=1234 "
